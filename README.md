# PROJET:
## Créer une application qui permet de gérer les applications ainsi que les executer.
## Etapes à faire:
### - ~~Créer l'interface graphique~~ - Réussi
...
### - Faire des tests de tout les boutons
